...
function moveLists(lists, _ref9) {
  ...
  return (0, _immutabilityHelper2.default)(lists, {
...
function moveItems(lists, _ref10) {
  ...
  if (fromListIndex === toListIndex) {
    return (0, _immutabilityHelper2.default)(lists, (0, _defineProperty3.default)({}, fromListIndex, {
      rows: {
  ...
  return (0, _immutabilityHelper2.default)(lists, (_update2 = {}, (0, _defineProperty3.default)(_update2, fromListIndex, {
    rows: {
      $splice: [[fromIndex, 1]]
    }
...
function moveItemToList(lists, _ref11) {
  ...
  return (0, _immutabilityHelper2.default)(lists, (_update3 = {}, (0, _defineProperty3.default)(_update3, fromListIndex, {
    rows: {
      $splice: [[fromIndex, 1]]
    }
